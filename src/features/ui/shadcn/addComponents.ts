...
`;
  ...
  try {
    console.log(pc.cyan("\r\r\r\ninstalling tailwind-merge\r\r\r\n"));
    const installCommandDev =
      ctx.manager === "npm" ? ["install", "--save-dev"] : ["add", "-D"];
    await run(
      ctx.manager,
    ...
    console.error(
      pc.red(
        "\r\r\r\nFailed to install tailwind-merge, continuing with shadcn add. You may need to install it manually.\r\r\r\n",
      ),
      error,
    );
  }
